...
impl<IT8951Interface: interface::IT8951Interface, TLocalBuffer: interface::LocalBuffer> IT8951<IT8951Interface, Run, TLocalBuffer> {
    ...
    pub fn reset(&mut self) -> Result<(), Error> {
        // TODO: check if needed, if so implement a generic clear method for all buffers
...
impl<IT8951Interface: interface::IT8951Interface, TLocalBuffer: interface::LocalBuffer> IT8951<IT8951Interface, PowerDown, TLocalBuffer> {
